...
import { matmul, euler_angle_to_rotate_matrix, transpose, psr_to_xyz, array_as_vector_range, array_as_vector_index_range, vector_range, euler_angle_to_rotate_matrix_3by3 } from "@/utils/tools"
...
function Lidar(sceneMeta, world, frameInfo) {
    ...
    this.preload = function (on_preload_finished) {
        ...
        loader.load(this.frameInfo.get_pcd_path(), // pcd云图需要前端读取: world.js -> get_pcd_path()
            //ok
            function (pcd) {
            ...
            function (error) {
                //error
                console.warn("Load PCD Failed: ", error);
                _self._afterPreload();
            },
